...
bot.command('tp', async (ctx) => {
    ...
    const processingMsg = await ctx.reply("⏳ 正在处理 (v3.2 Font Fix)...");
    ...
    try {
        ...
        ctx2d.fillStyle = "#888";
        ctx2d.fillText("Generated by Huiying Bot (v3.2 Font Fix)", padding, totalHeight - 10);
