...
// ==========================================================
// ✅ 功能 1 修复：/tp 使用 CustomFont (转为 PNG 避免黑屏)
// ==========================================================
bot.command('tp', async (ctx) => {
    ...
    const processingMsg = await ctx.reply("⏳ 正在处理 (v3.5 PNG Fix)...");
    ...
    try {
        ...
        ctx2d.font = `12px "CustomFont"`;
        ctx2d.fillStyle = "#888";
        ctx2d.fillText("Generated by Huiying Bot (v3.5 PNG)", padding, totalHeight - 10);

        // 🔴 修复关键 3：强制输出 PNG，解决 JPEG 变黑问题
